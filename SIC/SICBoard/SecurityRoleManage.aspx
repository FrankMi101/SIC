<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityRoleManage.aspx.cs" Inherits="SIC.SecurityRoleManage" Async="true" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="staff-container" style="margin-top: 5px;">
            <div class="staff-list">
                <a href="javascript:OpenRoleGroupNew();">
...
<script type="text/javascript">
    ...
    function OpenRoleGroupNew() {
        ...
        var roleID = "0";
        alert(appID);
        var para = "?UserID=" + userID + "&UserRole=" + userrole + "&AppID=" + appID + "&xID=" + roleID + "&xType=" + roleType + "&Action=Add";
        OpenInPage('New Security Role', page + para, "400","600");
    }

    //function OpenRoleActionPage(userID, userrole, appID, roleID, roleName,roleType,actionType) {
    //    var page = "../SICCommon/Security_Role.aspx"
    //    var para = "?UserID=" + userID + "&UserRole=" + userrole + "&AppID=" + appID + "&RoleID=" + roleID + "&RoleType=" + roleType  + "&Action=" +actionType ;
    //    if (actionType == "SubFun") {
    //        var goPage = "SecurityRoleManageSub.aspx" + para
    //        $("#IframeSubFunction").attr('src', goPage);
    //    }
    //    else {
    //    OpenInPage('Security Group', page, para, roleName);
    //    }
