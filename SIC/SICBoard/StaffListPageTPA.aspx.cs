...
namespace SIC
{ 
    public partial class StaffListPageTPA : System.Web.UI.Page
    {
        readonly string pageID = "TPAListPage";
        ...
        private List<AppraisalList> GetDataSource()
        {
            ...
            var myList = ListData.SearchGeneralList<AppraisalList>(pageID,parameter,btnSearchGo);
            return myList;
        }
