...
namespace SIC
{
    public partial class ClassListPage : System.Web.UI.Page
    {
        readonly string pageID = "ClassListPage";
        ...
        private void SetPageAttribution()
        {
            ...
            hfSelectedTab.Value =  schoolCode.Substring(0,2) == "05"? "Academic": "Regular";
        }
        ...
        private List<ClassesList> GetDataSource()
        {
            ...
            var myList = ListData.SearchGeneralList<ClassesList>(pageID,parameter, btnSearchGo);
            return myList;
        }
